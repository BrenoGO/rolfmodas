<?php
class PagSeguro{
	private $email         = "rolf@rolfmodas.com.br";
	private $token_sandbox = "DD9958AE06474C4FA901250926FDC123";
	private $token_oficial = "95D7DE222D224571A159A74645CA74E8";
	private $url_retorno   = "http://www.rolfmodas.com.br/pagseguro/notificacao.php";
	//private $url_retorno   = "localhost/rolfmodas.com.br/pagseguro/notificacao.php";
	...
	*/
	...
	private function generateUrl($dados,$retorno){
		...
		//Tratar telefone
		$telefone = implode("",explode("-",substr($dados['telefone'],3,strlen($dados['telefone']))));
	...
	public function executeCheckout($dbh,$dados,$retorno){
		$pedido=$dados['codigo'];
		...
		$stmt=$dbh->prepare("update pedidos set codigo_pagseguro=? where pedido=?");
		$stmt->execute(array($code,$pedido));
